package com.example.__WebFlux.application.auth.dtos.request;

import jakarta.validation.constraints.Email;
import jakarta.validation.constraints.NotNull;

public record LoginUserRequestDto(@NotNull(message = "El username no puede ser nulo!") String username,
